...
'''
Model architecture as defined in the paper. 
'''
class eye_mdoel(nn.Module):
    def __init__(self):
        super(eye_mdoel, self).__init__()
...
if __name__ == '__main__':
    test = gazetrack_model()
    out = test(torch.rand(4,3,128,128), torch.rand(4,3,128,128), torch.rand(4,8))
    print(out.shape)