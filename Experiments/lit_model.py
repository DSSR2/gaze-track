...
class lit_gazetrack_model(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        _, l_eye, r_eye, kps, y, _, _, _ = batch
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('lossLin', lossLin.item(), on_step=True, prog_bar=True, logger=True)
        self.logger.experiment.log_metric('val_loss', val_loss.item())
        self.logger.experiment.log_metric('val_err', lossLin.item())
        return val_loss
